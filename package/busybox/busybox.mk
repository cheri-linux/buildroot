...
ifeq ($(BR2_PACKAGE_JULIET),y)
define BUSYBOX_ENABLE_TIMEOUT
	$(call KCONFIG_ENABLE_OPT,CONFIG_TIMEOUT)
endef
else ifeq ($(BR2_PACKAGE_JULIET_CHERI),y)
define BUSYBOX_ENABLE_TIMEOUT
	$(call KCONFIG_ENABLE_OPT,CONFIG_TIMEOUT)
endef
endif
...
define BUSYBOX_INSTALL_BOOT_SCRIPT
	$(INSTALL) -D -m 0755 package/busybox/S00boot \
		$(TARGET_DIR)/etc/init.d/S00boot
endef

define BUSYBOX_INSTALL_INIT_SYSV
	$(BUSYBOX_INSTALL_BOOT_SCRIPT)
	$(BUSYBOX_INSTALL_MDEV_SCRIPT)
	$(BUSYBOX_INSTALL_LOGGING_SCRIPT)
	$(BUSYBOX_INSTALL_WATCHDOG_SCRIPT)
